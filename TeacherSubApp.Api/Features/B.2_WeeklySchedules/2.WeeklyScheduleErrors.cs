...
namespace TeacherSubApp.Api.Features.WeeklySchedules
{
    public static class WeeklyScheduleErrors
    {
        ...
        public static readonly Error TeacherSlotConflict = Error.Create(
            "WEEKLY_SCHEDULE_TEACHER_SLOT_CONFLICT",
            "The teacher already has an active schedule in this day and period.",
            "لدى المعلم جدول نشط بالفعل في هذا اليوم والحصة.");

        public static readonly Error ClassSlotConflict = Error.Create(
            "WEEKLY_SCHEDULE_CLASS_SLOT_CONFLICT",
            "The class already has an active schedule in this day and period.",
            "لدى الصف جدول نشط بالفعل في هذا اليوم والحصة.");

        public static readonly Error EventSlotConflict = Error.Create(
            "WEEKLY_SCHEDULE_EVENT_SLOT_CONFLICT",
            "The event-key already has an active schedule in this day and period.",
            "لدى الحدث جدول نشط بالفعل في هذا اليوم والحصة.");
    }
}
