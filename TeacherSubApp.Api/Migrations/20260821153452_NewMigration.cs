...
namespace TeacherSubApp.Api.Migrations
{
    ...
    public partial class NewMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SubstitutionAlgorithmSettings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SubjectMatchWeight = table.Column<double>(type: "double precision", nullable: false),
                    WeeklyLoadWeight = table.Column<double>(type: "double precision", nullable: false),
                    DailyLoadWeight = table.Column<double>(type: "double precision", nullable: false),
                    StandByWeight = table.Column<double>(type: "double precision", nullable: false),
                    SubbedYesterdayWeight = table.Column<double>(type: "double precision", nullable: false),
                    ConsecutiveClassWeight = table.Column<double>(type: "double precision", nullable: false),
                    EarlyLeaveWeight = table.Column<double>(type: "double precision", nullable: false),
                    OvertimeThreshold = table.Column<int>(type: "integer", nullable: false),
                    LowLoadThreshold = table.Column<int>(type: "integer", nullable: false),
                    DailyLoadThreshold = table.Column<int>(type: "integer", nullable: false),
                    RestPeriodBreak = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubstitutionAlgorithmSettings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAlgorithmMatch = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    AbsentTeacherNameAtTimeOfService = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    AbsentTeacherSubjectAtTimeOfService = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    SubstituteTeacherNameAtTimeOfService = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    SubstituteTeacherSubjectAtTimeOfService = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ClassNameAtTimeOfService = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "SubstitutionAlgorithmSettings",
                columns: new[] { "Id", "ConsecutiveClassWeight", "DailyLoadThreshold", "DailyLoadWeight", "EarlyLeaveWeight", "LowLoadThreshold", "OvertimeThreshold", "RestPeriodBreak", "StandByWeight", "SubbedYesterdayWeight", "SubjectMatchWeight", "WeeklyLoadWeight" },
                values: new object[] { 1, 14.279999999999999, 4, 14.279999999999999, 14.279999999999999, 12, 16, 4, 14.279999999999999, 14.279999999999999, 14.279999999999999, 14.279999999999999 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Substitutions_Slot_Date_Active",
                table: "Substitutions",
                columns: new[] { "WeeklyScheduleId", "ServiceDate" },
                unique: true,
                filter: "\"DeletedAt\" IS NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Substitutions_Teacher_Date_Period_Active",
                table: "Substitutions",
                columns: new[] { "SubstituteTeacherId", "ServiceDate", "PeriodNumberAtTimeOfService" },
                unique: true,
                filter: "\"DeletedAt\" IS NULL");
